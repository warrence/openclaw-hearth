...
main() {
  ...
  echo ""
  echo -e "  ${YELLOW}⚠️  Before you start chatting, set up your AI provider:${NC}"
  echo ""
  echo -e "     ${CYAN}openclaw setup${NC}"
  echo ""
  echo -e "  This will ask you to choose a model (e.g. OpenAI, Anthropic,"
  echo -e "  Google) and sign in. Without this, your assistant can't respond."
  echo ""
  echo -e "  After that:"
  echo ""
  echo -e "  Start:   ${CYAN}cd $HEARTH_DIR && npm run start${NC}"
