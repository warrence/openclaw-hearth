...
export const openClawConfig = registerAs(
  ...
  (): OpenClawConfig => ({
    ...
    fastModel: process.env.OPENCLAW_FAST_MODEL || process.env.OPENCLAW_DEFAULT_MODEL || 'openclaw',   // fallback only; hearth.json takes priority
    deepModel: process.env.OPENCLAW_DEEP_MODEL || process.env.OPENCLAW_DEFAULT_MODEL || 'openclaw', // fallback only; hearth.json takes priority
